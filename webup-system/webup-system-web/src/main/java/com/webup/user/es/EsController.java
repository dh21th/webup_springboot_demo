//package com.webup.user.es;
//
//import com.alibaba.fastjson.JSONObject;
//import com.webup.soa.utils.ValidatorUtil;
//import com.webup.user.es.utils.ElasticsearchUtil;
//import com.webup.user.es.utils.EsPage;
...
//        JSONObject jsonObject = null ;// (JSONObject) JSONObject.toJSON(esModel);
//        String id = ElasticsearchUtil.addData(jsonObject, indexName, esType, jsonObject.getString("id"));
//        return id;
//    }
//
...
//        if(ValidatorUtil.isNotNull(startPage) && ValidatorUtil.isNotNull(pageSize) ) {
//            BoolQueryBuilder boolQuery = QueryBuilders.boolQuery();
//            boolQuery.must(QueryBuilders.rangeQuery("date").from("2018-04-25T08:33:44.840Z")
//                    .to("2018-04-25T10:03:08.081Z"));
