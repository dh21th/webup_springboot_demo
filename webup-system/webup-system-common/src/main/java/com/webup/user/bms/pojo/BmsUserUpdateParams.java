...
//import com.webup.soa.base.BaseCreateOperationEntity;
 ...
 * @version 1.2
 * @project yzys
 * @class_name BmsUserUpdateParams
 * @table_name bms_user
 * @date 2017-07-31 17:54
 */
public class BmsUserUpdateParams extends BaseCreateOperationEntity<Integer> {
    ...
    public String toString() {
        return "BmsUserUpdateParams{" +
                ...
                ", regTime=" + regTime +
                ", binedPhoneFlag=" + binedPhoneFlag +
                ", binedEmailFlag=" + binedEmailFlag +
                ", allowLogin=" + allowLogin +
                ", verifyedFlag=" + verifyedFlag +
                ", userName='" + userName + '\'' +
                ", phonevsid='" + phonevsid + '\'' +
                ", cername='" + cername + '\'' +
