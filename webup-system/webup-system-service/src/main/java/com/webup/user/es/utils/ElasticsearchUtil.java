//package com.webup.user.es.utils;
//
//import com.alibaba.fastjson.JSONObject;
//import com.webup.soa.utils.ValidationUtils;
...
//
//        if (ValidatorUtil.isNotNull(fields)) {
...
//
////排序字段
//        if (ValidatorUtil.isNotNull(sortField)) {
//            searchRequestBuilder.addSort(sortField, SortOrder.DESC);
//        }
//
//// 高亮（xxx=111,aaa=222）
//        if (ValidatorUtil.isNotNull(highlightField)) {
