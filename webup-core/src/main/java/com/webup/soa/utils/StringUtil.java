...
public class StringUtil {
    ...
    public static String phoneMask(String phone) {
        return null != phone && phone.length() >= 8 ? phone.substring(0, 3) + "****" + phone.substring(7) : phone;
    }
     ...
     * @return
     */
    public static String stringSub(int num, String str) {
    ...
    public static String filterEmoji(String source) {
        if (ValidatorUtil.isNotNull(source)) {
